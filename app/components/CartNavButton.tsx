...
export function CartNavButton() {
  ...
  return (
    <Link
      href="/cart"
      aria-label={label}
      className="relative inline-flex items-center justify-center rounded-full border border-white/15 bg-black/20 px-3 py-2 text-zinc-100 transition hover:border-white/30"
    >
      <svg
        width="18"
        height="18"
